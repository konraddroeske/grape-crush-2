...
const ProductSubheading: FunctionComponent<Props> = ({
  ...
  const variants = {
    card: 'flex flex-wrap justify-start text-sm capitalize h-5 font-bold overflow-hidden',
    slideshow:
      'flex flex-wrap justify-start text-sm capitalize h-5 font-bold overflow-hidden',
  }
